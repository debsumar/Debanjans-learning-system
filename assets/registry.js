...
globalThis.LEARNING_SYSTEM = {
  ...
  diagramCatalogue: {
    archetypes: {
      "flow-chain": {
        ...
        uses: [{ chapter: "c01", section: "responsibility", label: "Shared responsibility progression from on-premises to SaaS" }, { chapter: "c06", section: "redundancy", label: "Azure Storage redundancy options and failure scopes" }, { chapter: "c07", section: "directory", label: "Identity authentication, Conditional Access, and RBAC authorization flow" }, { chapter: "c08", section: "tools", label: "Azure cost lifecycle from estimation through deployment, analysis, optimization, tagging, and reporting." }, { chapter: "c10", section: "iac", label: "Azure management surfaces funnel through Azure Resource Manager, while data plane calls use resource endpoints." }, { chapter: "c11", section: "telemetry", label: "Azure Monitor telemetry sources, analysis, alerts, and health views" }]
      },
      "comparison-columns": {
        count: 2,
        requiredDataFields: ["nodes", "labels", "edges", "groups"],
  ...
  confusionSets: [
    ...
    { id: "iaas-paas-saas", discriminator: "More service means less customer management: infrastructure, platform, then complete application.", objectiveIds: ["az900-c01-o7", "az900-c03-o1", "az900-c03-o2", "az900-c03-o3", "az900-c03-o4"], calloutChapter: "c03", hubLinkTarget: "03-service-types.html#use-cases" },
